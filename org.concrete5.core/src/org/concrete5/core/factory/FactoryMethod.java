...
public class FactoryMethod implements Serializable {
	...
	public final String definerResourcePath;
	...
	public FactoryMethod(String definerResourcePath, String className, String methodName, int discrimintatorIndex, int type) {
